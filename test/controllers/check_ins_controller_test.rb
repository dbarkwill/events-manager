...
class CheckInsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check_in" do
    assert_difference("CheckIn.count") do
      post check_ins_url, params: { check_in: { customer_id: @check_in.customer_id, employee_id: @check_in.employee_id, registration_id: @check_in.registration_id } }
    end
  ...
  test "should update check_in" do
    patch check_in_url(@check_in), params: { check_in: { customer_id: @check_in.customer_id, employee_id: @check_in.employee_id, registration_id: @check_in.registration_id } }
